...
export default function InvoiceIncomeReader() {
  ...
  return (
    <div style={{ padding: '20px' }}>
      <h2>Lector de Ingresos (Facturas Emitidas)</h2>
      <p style={{ fontSize: '14px', color: '#666' }}>
        Arrastra aquí PDF, imágenes o documentos de facturas emitidas por Newzelland.
      </p>
        ...
        >
          ...
          {archivo.estado === 'ok' && archivo.factura && (
            <div style={{ marginTop: '16px' }}>
              ...
              >
                📤 Ingreso | {archivo.factura.tipoDocumento}
              </div>
